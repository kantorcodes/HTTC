 ...
 * Generated for Laravel 5.1.7 (LTS) on 2015-08-17.
 *
...
namespace {
    ...
    class Extensions extends \Cartalyst\Extensions\Laravel\Facades\Extensions{
        ...
        public static function forget($key){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::forget($key);
        }
        ...
        public static function groupBy($groupBy, $preserveKeys = false){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::groupBy($groupBy, $preserveKeys);
        }
        ...
        public static function last($callback = null, $default = null){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::last($callback, $default);
        }
        ...
        public static function pluck($value, $key = null){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::pluck($value, $key);
        }
        ...
        public static function max($key = null){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::max($key);
        }
        ...
        public static function min($key = null){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::min($key);
        }
        ...
        public static function prepend($value){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::prepend($value);
        }
        ...
        public static function push($value){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::push($value);
        }
        ...
        public static function put($key, $value){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::put($key, $value);
        }
        ...
        public static function unique($key = null){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::unique($key);
        }
        ...
        public static function zip($items){
            //Method inherited from \Illuminate\Support\Collection            
            return \Cartalyst\Extensions\ExtensionBag::zip($items);
        }
